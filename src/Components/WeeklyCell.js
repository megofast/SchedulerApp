...
function WeeklyCell(props) {
    const { weeklyAppointments, weeklySelectedCells } = useSelector( (state) => state.appointmentReducer);
    ...
    const clearSelections = () => {
        ...
        for (let cell in weeklySelectedCells) {
            gridRefs.current[weeklySelectedCells[cell]].style.backgroundColor = 'white';
        }
        dispatch(resetWeeklySelectedCells());
    }
