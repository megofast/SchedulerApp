    ...
    return (
        <Container>
            <Row>
                ...
                <Col className="pb-2 text-center"><h3>Week Range</h3></Col>
            ...
            <Row>
                <Col md={1}></Col>
                {
                    ...
                    return <Col key={i} className="border bg-white"><span className="text-center fw-bold">{weekday}</span><br/>{currentDay.day(i).format('MM/DD/YYYY')}</Col>
                })
                }
            </Row>
            <Row>
